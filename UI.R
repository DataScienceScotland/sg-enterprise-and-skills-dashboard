...
options(spinner.color = "#F1A864", spinner.size = 1, spinner.color.background = "#FFFFFF",spinner.type = 4,proxy.height = "10px",
...
header <- wellPanel( 
  div(
  actionButton(inputId  =  "homeButton",  label  =  NULL, 
               style  =  "width: 300px;
                            height:60px;
...
body <- navbarPage(
  ...
  tabPanel("Home", icon = icon("home"), 
           fluidRow(
             ...
             column(6,
                    div(align = "center", id = "SetEffects",
  ...
  #### Background ####
  tabPanel("Background", icon = icon("info"), 
           fluidRow(
             div(
  ...
  navbarMenu("Productivity", icon = icon("industry"), 
             tabPanel("Summary Table", value = "productivitySummary",
                      h2("Overview"),
                      tabsetPanel(
                        tabPanel("Scotland", 
                                 fluidRow(width = 12,
             ...
             tabPanel("Access to Superfast Broadband", value = "Access_to_superfast_broadband_page",
                      ES_thirdPage_UI("accessBroadband", "Access to superfast broadband")
                      ),
             tabPanel("Economic Growth", value = "Economic_growth_page",
                      ES_thirdPage_UI("econGrowth", "Economic growth")
             ),
             tabPanel("Economic Participation", value = "Economic_participation_page",
                      ES_thirdPage_UI("econParticipate", "Economic participation")
             ),
             tabPanel("Educational Attainment", value = "Educational_attainment_7_page",
                      ES_thirdPage_UI("eduAttain7", "Educational attainment")
             ),
             tabPanel("Entrepreneurial Activity", value = "Entrepreneurial_activity_page",
                      ES_thirdPage_UI("entAct", "Entrepreneurial activity")
             ),
             tabPanel("High Growth Businesses", value = "High_growth_businesses_page",
                      ES_thirdPage_UI("highGrowth", "High growth businesses")
             ),
             tabPanel("Innovative Businesses", value = "Innovative_businesses_page",
                      ES_thirdPage_UI("innovateBus", "Innovative businesses")
             ),
             tabPanel("International Exporting", value = "International_exporting_page",
                      ES_thirdPage_UI("intExp", "International Exporting")
             ),
             tabPanel("Productivity", value = "Productivity_page",
                      ES_thirdPage_UI("productivity", "Productivity")
             ),
             tabPanel("Scotland's Reputation", value = "Scotlands_Reputation_page",
                      ES_thirdPage_UI("scotRep", "Scotland's Reputation")
             ),
             tabPanel("Skill Profile of the Population", value = "Skill_profile_of_the_population_page",
                      ES_thirdPage_UI("skillProfile", "Skill Profile of the Population")
             ),
             tabPanel("Skills Shortage Vacancies", value = "Skills_shortage_vacancies_page",
                      ES_thirdPage_UI("skillShort", "Skills shortage vacancies")
             ),
             tabPanel("Skills Underutilisation", value = "Skills_underutilisation_page",
                      ES_thirdPage_UI("skillUnder", "Skills Underutilisation")
             ),
             tabPanel("Spend on Research and Development", value = "Spend_on_Research_and_Development_page",
                      ES_thirdPage_UI("spendRD", "Spend on Research and Development")
             ),
             tabPanel("The Number of Businesses", value = "The_number_of_businesses_page",
                      ES_thirdPage_UI("numberBusiness", "The number of businesses")
             ),
             tabPanel("Work Place Learning", value = "Work_place_learning_page",
                      ES_thirdPage_UI("workLearn", "Work place learning")
             ),
             tabPanel("Young People's Participation", value = "Young_peoples_participation_page",
                      ES_thirdPage_UI("youngParticipate", "Young people's participation")
             )
  ), 
  #### Equality Section ####
  navbarMenu("Equality", icon = icon("people-carry"), 
             tabPanel("Summary Table", value = "equalitySummary",
                      h2("Overview"),
                      tabsetPanel(
                        tabPanel("Scotland", 
                                 fluidRow(width = 12,
             ...
             tabPanel("Gender Balance in Organisations", value = "Gender_balance_in_organisations_page",
                      ES_thirdPage_UI("genderBalance", "Gender balance in organisations")
             ),
             tabPanel("Income Inequality", value = "Income_inequality_page",
                      ES_thirdPage_UI("incomeInequal", "Income inequality")
             ),
             tabPanel("Pay Gap", value = "Pay_gap_page",
                      ES_thirdPage_UI("payGap", "Pay gap")
             )
  ),
  #### Welllbeing Section ####
  navbarMenu("Wellbeing", icon = icon("spa"), 
             tabPanel("Summary Table", value = "wellbeingSummary",
                      h2("Overview"),
                      tabsetPanel(
                        tabPanel("Scotland", 
                                 fluidRow(width = 12,
             ...
             tabPanel("Employee Voice", value = "Employee_voice_page",
                      ES_thirdPage_UI("employeeVoice", "Employee voice")
             ),
             tabPanel("Employees on the Living Wage", value = "Employees_on_the_Living_wage_page",
                      ES_thirdPage_UI("empLivingWage", "Employees on the Living wage")
             ),
             tabPanel("Mental Wellbeing", value = "Mental_wellbeing_page",
                      ES_thirdPage_UI("mentalWellbeing", "Mental wellbeing")
             ),
             tabPanel("Social Capital", value = "Social_capital_page",
                      ES_thirdPage_UI("socialCapital", "Social capital")
             )
  ),
  #### Sustainability Section ####
  navbarMenu("Sustainability", icon = icon("tree"), 
             tabPanel("Summary Table", value = "sustainabilitySummary",
                      h2("Overview"),
                      tabsetPanel(
                        tabPanel("Scotland", 
                                 fluidRow(width = 12,
             ...
             tabPanel("Carbon Footprint", value = "Carbon_footprint_page",
                      ES_thirdPage_UI("carbonFoot", "Carbon footprint")
             ),
             tabPanel("Energy from Renewable Sources", value = "Energy_from_renewable_sources_page",
                      ES_thirdPage_UI("energyRenew", "Energy from renewable sources")
             ),
             tabPanel("Greenhouse Gas Emissions", value = "Greenhouse_gas_emissions_page",
                      ES_thirdPage_UI("greenGas", "Greenhouse gas emissions")
             ),
             tabPanel("Natural Capital", value = "Natural_capital_page",
...
ui <- fluidPage(theme = shinytheme("paper"), ## Sets the base blue theme
